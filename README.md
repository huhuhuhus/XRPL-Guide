...
# XRPL Node Setup Guide

This guide will walk you through setting up an XRPL EVM node from scratch.
...
We will use Go v1.23.4 as an example.
...
Replace YOUR_MONIKER with your preferred name:
...
Configure Ports, Pruning, Gas Price, and Indexing

echo "export XRPL_PORT="47"" >> $HOME/.bashrc
source $HOME/.bashrc

Modify app.toml and config.toml:
...
Create a service file at /etc/systemd/system/exrpd.service:
...
Your XRPL node should now be running successfully. To check its status:
...
Maintainer: EmberValidator
Website: embervalidator.top
